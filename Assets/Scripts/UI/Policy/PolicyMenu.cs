...
<<<<<<< HEAD
        ...
        AddEventTrigger(patientTabButton.gameObject, EventTriggerType.PointerClick, (data) => {
            ChangePolicy("Patient", patientTabButton);
            BtnSoundManager.Instance.PlayButtonSound();
        });
        AddEventTrigger(researchTabButton.gameObject, EventTriggerType.PointerClick, (data) => {
